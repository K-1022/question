...
public interface StoreRepository extends JpaRepository<Store, Integer> {
    ...
    public Page<Store> findByGenreLikeOrderByCreatedAtDesc(String genre, Pageable pageable);  
    public Page<Store> findByGenreLikeOrderByPriceAsc(String genre, Pageable pageable);  
    ...
    public List<Store> findTop10ByOrderById();
}
